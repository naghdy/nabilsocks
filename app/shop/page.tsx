...
export const metadata: Metadata = {
  title: "Shop",
  description: "The Nabil Socks catalog — crews, ankles, limited drops, technical no-shows.",
};
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-3 max-w-xl text-muted">
        Ten pairs. Distinctive colorways, heights, and materials. Limited drops do
